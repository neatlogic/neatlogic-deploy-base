package neatlogic.framework.deploy.dto.sql;
...
public class DeploySqlNodeDetailVo extends BaseEditorVo implements ISqlNodeDetail {
    ...
    public DeploySqlNodeDetailVo(String jobPhaseName,Long jobId,Long sysId, Long moduleId, Long envId, String version) {
        this.sysId = sysId;
        this.moduleId = moduleId;
        this.envId = envId;
        this.version = version;
        this.phaseName = jobPhaseName;
        this.jobId = jobId;
    }
