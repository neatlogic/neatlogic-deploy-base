...
public class DeployAppConfigModuleRunnerGroupNotFoundException extends ApiRuntimeException {
    ...
    public DeployAppConfigModuleRunnerGroupNotFoundException(String appSystem, String systemModule) {
        super("nfde.deployappconfigmodulerunnergroupnotfoundexception.deployappconfigmodulerunnergroupnotfoundexception", (StringUtils.isBlank(appSystem) ? StringUtils.EMPTY : appSystem), (StringUtils.isBlank(systemModule) ? StringUtils.EMPTY : systemModule));
    }
}
