...
public class DeployVersionParentDependencyNotFoundException extends ApiRuntimeException {
    ...
    public DeployVersionParentDependencyNotFoundException(DeployPackageVo packageVo) {
        super("nfde.deployversionparentdependencynotfoundexception.deployversionparentdependencynotfoundexception", packageVo.getGroupId(), packageVo.getArtifactId(), packageVo.getVersion());
    }
